...
public enum InputKeyEvent {
  ...
  KEYCODE_NUMPAD_MULTIPLY (155, "'*' key (for multiplication). "),
  ...
  private InputKeyEvent(int code, String description){
    this.code = code;
    this.description = description;
  }
  
  private InputKeyEvent(int code, String description, char character){
    this(code,description);
    this.characterToReplace = character;
  }
  
  private InputKeyEvent(int code, String description, int keyCode){
    this(code,description);
