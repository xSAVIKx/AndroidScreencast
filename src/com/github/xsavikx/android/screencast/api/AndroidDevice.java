...
import com.github.xsavikx.android.screencast.api.injector.NullSyncProgressMonitor;
...
public class AndroidDevice {
  ...
  public void pushFile(File localFrom, String remoteTo) {
    ...
    try {
      ...
      device.getSyncService().pushFile(localFrom.getAbsolutePath(), remoteTo, new NullSyncProgressMonitor());
